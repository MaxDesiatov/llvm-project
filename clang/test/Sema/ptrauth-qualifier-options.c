...
// expected-error@-1 {{repeated '__ptrauth' authentication mode 'sign-and-strip', prior mode was 'strip'}}
...
// expected-error@-1 {{expected a comma before 'isa-pointer' in '__ptrauth' options argument}}
